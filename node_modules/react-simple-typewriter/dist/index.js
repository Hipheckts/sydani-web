...
var Typewriter = function Typewriter(_ref) {
  ...
  var _useState = React.useState(typeSpeed),
      speed = _useState[0],
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("span", null, text), cursor && React__default.createElement("span", {
    className: styles.blinkingCursor
  }, cursorStyle));
};

var index = React.memo(Typewriter);
